"""Evaluate the frozen five-session financing net-sale hypothesis."""
...
from .financing_sell_study import CONTROL, TREATED
...
def main() -> None:
    ...
    parser.add_argument("--report", type=Path,
                        default=Path("data/research/financing_sell_report.json"))
    parser.add_argument("--trades", type=Path,
                        default=Path("data/research/financing_sell_trades.parquet"))
    parser.add_argument("--reprice-signals", type=Path,
                        default=Path("data/research/financing_sell_reprice_signals.parquet"))
    parser.add_argument("--repriced", type=Path)
    parser.add_argument("--repriced-report", type=Path,
                        default=Path("data/research/financing_sell_reprice_report.json"))
