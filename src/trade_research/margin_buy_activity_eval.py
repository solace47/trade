"""Evaluate the frozen five-session margin-purchase activity groups."""
...
def main() -> None:
    ...
    parser.add_argument("--report", type=Path,
                        default=Path("data/research/margin_buy_activity_report.json"))
    parser.add_argument("--trades", type=Path,
                        default=Path("data/research/margin_buy_activity_trades.parquet"))
    parser.add_argument("--reprice-signals", type=Path,
                        default=Path("data/research/margin_buy_activity_reprice_signals.parquet"))
    parser.add_argument("--repriced", type=Path)
    parser.add_argument("--repriced-report", type=Path,
                        default=Path("data/research/margin_buy_activity_reprice_report.json"))
