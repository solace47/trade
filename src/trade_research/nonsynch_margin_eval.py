"""Evaluate the frozen price non-synchronicity and margin-interest groups."""
...
from .nonsynch_margin_study import CONTROL, TREATED
...
def main() -> None:
    ...
    parser.add_argument("--report", type=Path,
                        default=Path("data/research/nonsynch_margin_report.json"))
    parser.add_argument("--trades", type=Path,
                        default=Path("data/research/nonsynch_margin_trades.parquet"))
    parser.add_argument("--reprice-signals", type=Path,
                        default=Path("data/research/nonsynch_margin_reprice_signals.parquet"))
    parser.add_argument("--repriced", type=Path)
    parser.add_argument("--repriced-report", type=Path,
                        default=Path("data/research/nonsynch_margin_reprice_report.json"))
